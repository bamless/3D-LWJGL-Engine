...
/**
 * Loads a 3D model in memory by storing
 * positional data in a VAO
 * @author Fabrizio
 *
 */
public class Loader {
    ...
    /**
     * Loads the vbo containing the vertices of the model as the no.0 
     * of the vao attribute list.
     * @param positions
	...
	try {
	    texture = TextureLoader.getTexture("PNG", Loader.class.getResourceAsStream("/resources/" + fileName + ".png"));
	...
	GL15.glBufferData(GL15.GL_ARRAY_BUFFER, buffer, GL15.GL_STATIC_DRAW);//stores data in it
	GL20.glVertexAttribPointer(attributeNumber, coordinateSize, GL11.GL_FLOAT, false, 0, 0);//stores it in the pos 0 of the vao attr. list
    ...
    /**
     * Loads the index buffer vbo and binds it
     * to the vao
     * @param indices
     */
    ...
    */
    ...
    /**
     * Converts the float array in a float buffer (needed to store data in the VBO)
     * @param data
     * @return
     */
